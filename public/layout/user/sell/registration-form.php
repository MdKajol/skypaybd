<?php
   ...
   if(is_post_request()) {
      ...
      if(!$errors) {
         ...
         $col = ["user_id", "sell_dollar_amount", "sell_receive_details", "sell_dollar_to_taka", "sell_payment_details"];
         $val = [$user["user_id"], $buy_dollar_amount, $pay_d, $buy_dollar_to_taka, $rec_d];
         $inserted = db_insert("sky_sell", $col, $val);
         if($inserted) {
            $_SESSION["message"] = "your selling request has been done";
         } else {
   ...
   <div class="row">
      <div class="col-12 order-1 col-sm-12 order-sm-1 col-md-6 order-md-0">
         <div class="olympia-form">
            ...
            <?php echo showError(); ?>
            <h2 class="olympia-title-min">Sell Dollar</h2>
            <div class="user form-wrapper">
               <form id="regitration-form" action="" method="POST">
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input id="sellDollar" type="text" name="buy_dollar_amount" value="" autocomplete="off" placeholder="Dollar" required>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-group">
                           <label for="">You will get <small>(taka)</small></label>
                           <input id="dollarInTaka" type="text" name="buy_dollar_to_taka" value="" autocomplete="off" placeholder="Taka" readonly>
                        </div>
                     </div>
                  </div>

                  <div class="user-payment how-user-receive user-sell-pay">
                     <div class="receivedMethod">
                        <div class="form-group">
                           <label for="">How you pay <small>(dollar)</small></label>
                           <!-- Default checked -->
                           <select name="rec_d[pay_method]" id="receivedMethod" class="custom-select" required>
                  ...
                  <div class="user-payment how-user-pay user-sell-rec">
                     <div class="paymentMethod">
                        <div class="form-group">
                           <label for="">How you want to receive <small>(taka)</small></label>
                           <!-- Default checked -->
                              <select name="pay_d[receive_method]" id="paymentMethod" class="custom-select" required>
                                 <option value="">Select One</option>
