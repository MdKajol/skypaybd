...
<head>
   ...
   <link rel="stylesheet" href="<?php echo link_css("slicknav.min.css"); ?>">
   ...
   <link rel="stylesheet" href="<?php echo link_css("favicon.min.css"); ?>">
   ...
   <link rel="stylesheet" href="<?php echo link_css("responsive.css"); ?>">
	<title>Skypaybd</title>
   <style>
      .olympia-nav .slicknav_menu {
         position: absolute;
      }
   </style>
</head>
...
<!-- header start -->
<header  id="home-fullscreen" class="header flex-container" style="position: static;">
	...
	<div class="olympia-menu flex-item">
		<nav class="olympia-nav">
			<ul  id="olympia-menu" class="flex-container">
				<li class="flex-item"><a href="" class="nav-active" >Home</a></li>
				<li class="flex-item">
